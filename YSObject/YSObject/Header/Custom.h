...
#define orderUrlAll(a,b,c) [NSString stringWithFormat:@"http://183.196.249.184:9003/driver.ashx?func=updateordergrab&orderidid=%ld&driverid=129&companyid=23&%@&token=%@",a,b,c]
