...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    appearanceNavigationBar.backIndicatorImage = [UIImage imageNamed:@"nav_left_icon"];
    appearanceNavigationBar.backIndicatorTransitionMaskImage = [UIImage imageNamed:@"nav_left_icon"];
    appearanceNavigationBar.tintColor = [UIColor colorWithRGBHex:0x222222];
    appearanceNavigationBar.shadowImage = [UIImage new];
